...
{
    public static readonly Event.Type INSERT = new Event.Insert("Insert Tax Rate", "taxRates");
    public static readonly Event.Type UPDATE = new Event.Update("Update Tax Rate", "taxRates");
